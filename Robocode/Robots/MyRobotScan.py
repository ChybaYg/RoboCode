...
class MyRobotScan(Robot):
	...
	def onBulletHit(self, botId, bulletId):  # NECESARY FOR THE GAME
		...
		sendData = ";".join([f'{x:.2f}' for x in self.bullets[bulletId]])
		sendData += ";1" 
	...
	def onTargetSpotted(self, botId, botName, botPos):  # NECESARY FOR THE GAME
		...
		bulletId = self.fire(1)
		self.bullets[bulletId] = [dx, dy, my_gun_angle, self.enemies[botId]["velx"], self.enemies[botId]["vely"]]
